...
INSTALLED_APPS = [
    "unfold",  # <--- Unfold 必须在 django.contrib.admin 之前
    "unfold.contrib.filters",  # 可选：增强的过滤器
    "unfold.contrib.forms",  # 可选：增强的表单
    "unfold.contrib.import_export",  # 可选：如果使用了 django-import-export
    "unfold.contrib.guardian",  # 可选：如果使用了 django-guardian
    "unfold.contrib.simple_history",  # 可选：如果使用了 django-simple-history
...
UNFOLD = {
    "SITE_TITLE": "Printerify Admin",
    "SITE_HEADER": "Printerify",
    "SITE_URL": "/",
    # "SITE_ICON": {
            ...
            },
            {
                ...
                "items": [
                    ...
                    },
                    {
                        "title": "文件管理",
                        "icon": "description",
                        "link": reverse_lazy("admin:api_document_changelist"),
                    },
                ],
            },
            {
