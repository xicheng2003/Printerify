...
欢迎使用 Printerify（以下简称“本服务”）。本服务条款构成您（以下简称“用户”）与 Printerify（以下简称“我们”）之间具有法律约束力的协议。在访问或使用本服务之前，请您务必仔细阅读并充分理解本条款的全部内容。您通过注册、登录、上传文件、下单或任何其他方式使用本服务，即表示您已阅读、理解并同意接受本条款所有内容的约束。若您不同意本条款的任何内容，请立即停止使用本服务。
