<template>
  <div class="terms-page">
    <h1>关于 Printerify</h1>
    <p>Printerify 是一个为您提供便捷、高效在线打印服务的平台。</p>
    <hr />

    <h2>服务条款 (Terms of Service)</h2>
    <div class="terms-content">
      <h3>引言与协议接受</h3>
      <p>欢迎使用 Printerify，本服务条款构成您（以下简称“用户”）与 Printerify（以下简称“我们”）之间具有法律约束力的协议。在访问或使用本服务之前，请您务必仔细阅读并充分理解本条款的全部内容。您通过注册、登录、上传文件、下单或任何其他方式使用本服务，即表示您已阅读、理解并同意接受本条款所有内容的约束。若您不同意本条款的任何内容，请立即停止使用本服务。</p>
      ...
      <h3>用户行为与内容规范</h3>
      <p>用户承诺在使用本服务时，将严格遵守所有适用的法律法规。您对通过本服务上传、提交或分享的所有文件、数据及信息（以下统称为“用户内容”）负有完全的法律责任。您必须保证，您所上传的用户内容拥有合法的知识产权，或已获得相关权利人的充分授权，不会侵犯任何第三方的版权、商标权、专利权、肖像权、隐私权或其他合法权益。严禁用户利用本服务上传、打印或传播任何包含非法、淫|秽色|情、暴力、恐怖、赌|博、诽谤、骚扰、种族歧视或任何其他违反法律、道德及社会公序良俗的内容。Printerify 有权单方面判断用户内容是否违反本条款，并无需通知即可拒绝打印、删除相关内容，并视情节严重程度，暂停或永久终止向该用户提供服务。</p>
      ...
      <h3>法律适用与争议解决</h3>
      <p>本条款的订立、生效、解释、履行及争议解决，均适用中华人民共和国（为本模板目的，不含港澳台地区）的法律。因本条款产生的或与本条款有关的任何争议，双方应首先尝试通过友好协商解决。如果协商不成，任何一方均有权将争议提交至 Printerify 服务提供方所在地有管辖权的人民法院通过诉讼解决。</p>
    </div>
