...
<template>
  ...
  <div class="query-container">
    ...
    <div v-else-if="searchResult" class="result-card">
      <h3>查询结果</h3>
      <div v-if="searchResult.is_estimated || searchResult.page_count_source === 'estimated' || (searchResult.groups || []).some(g => (g.documents || []).some(d => d.page_count_source !== 'exact'))" class="order-estimated-alert">
